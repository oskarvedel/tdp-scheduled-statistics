 ...
 */
function extract_geolocation_slug_via_url_statistics()
{
 ...
 */
function extract_geolocation_id_via_url_statistics()
{

    // Get the geolocation slug from the URL
    $slug = extract_geolocation_slug_via_url_statistics();
...
function get_statistics_data_for_single_gd_place_statistics($gd_place_id)
{
